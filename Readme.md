...
The DXPropertyGrid supports a large number of attributes from the `System.ComponentModel.DataAnnotations` library as well DevExpress attributes, and you can use them to control the way properties are displayed.
